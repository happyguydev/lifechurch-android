...
//        }
        ...
        if (prefs != null) {
            ...
            int color = prefs.getInt("setbackgroundcolor", Color.parseColor("#B2C7DA"));
    ...
    private void initDirectToolbar(final IChatUser recipient) {
        ...
        toolbar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                blockDatabase = FirebaseDatabase.getInstance().getReference().child("/apps/" + ChatManager.Configuration.appId + "/BlockUser/" + recipient.getId());
                blockDatabase.addListenerForSingleValueEvent(new ValueEventListener() {
                    @Override
                    public void onDataChange(DataSnapshot dataSnapshot) {
                        if (dataSnapshot.exists()) {
                            String flag = dataSnapshot.child(FirebaseAuth.getInstance().getCurrentUser().getUid()).child("blockStatus").getValue(String.class);
                            if (flag.equals("Block Message,Profile Clicked")) {
                                Toast.makeText(MessageListActivity.this, "You can't access this profile", Toast.LENGTH_LONG).show();
                            }else {
        ...
        new AlertDialog.Builder(this)
                ...
                .setPositiveButton(getString(android.R.string.yes), new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        // upload the file
                        uploadFile(file);
                        //TODO; image sending automatically
