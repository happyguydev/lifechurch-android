...
public class ChatUI implements Serializable {
    ...
    public static final int REQUEST_CODE_PROFILE_ACTIVITY = 200;
...
//    }
    ...
    public void openContactListFragment(FragmentManager fragmentManager,
                                              @IdRes int containerId) {
...
private void processGroupNotification(Bundle extras, String channel) {
    ...
    public static String getUser_email(){  return user_email; }
    ...
    public static void setUser_pass(String password){
        user_pass = password;
    }
