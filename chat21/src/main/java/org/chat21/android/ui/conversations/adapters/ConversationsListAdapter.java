...
public class ConversationsListAdapter extends AbstractRecyclerAdapter<Conversation,
    ...
    public void onBindViewHolder(ViewHolder holder, final int position) {
        ...
        setRecipientDisplayName(holder, conversation);
    ...
    private void setRecipientDisplayName(ViewHolder holder, Conversation conversation) {
        if (conversation.isDirectChannel()) {
            String name = conversation.getConvers_with_fullname();
            String id = conversation.getConvers_with();
            String displayName = StringUtils.isValid(name) ? name : id;
            ...
            if (chatGroup != null)
                holder.recipientDisplayName.setText(chatGroup.getName());
        } else {
            Toast.makeText(holder.itemView.getContext(),
                    "channel type is undefined",
                    Toast.LENGTH_SHORT)
