...
//        FirebaseUser currentUser = mAuth.getCurrentUser();
    ...
    final protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        Log.d(DEBUG_LOGIN, "ChatSplashActivity.onActivityResult: requestCode == " + requestCode + " resultCode == " + resultCode);
        ...
        new Handler().postDelayed(new Runnable() {
            ...
            public void run() {
                ...
                if (FirebaseAuth.getInstance().getCurrentUser() != null) {
                    ...
                    Intent targetIntent = new Intent(ChatSplashActivity.this, getTargetClass());
...
//            startActivityForResult(getLoginIntent(), LOGIN_REQUEST);
                    startActivityForResult(new Intent(ChatSplashActivity.this, ChatLoginActivity.class), LOGIN_REQUEST);
                }
